defmodule S7 do
  ...
  S7comm-plus, symbolic addressing, alarms, and programmer diagnostics are
  outside the current scope. The client supports bounded classic block upload,
  opt-in destructive block management and CPU control, bounded SZL reads,
