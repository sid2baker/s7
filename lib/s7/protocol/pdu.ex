defmodule S7.Protocol.PDU do
  @moduledoc """
  A generic S7 PDU with opaque parameter and data fields.
  """
  ...
  @doc """
  Creates a PDU and derives its header lengths from the supplied fields.
  """
  ...
  @doc """
  Encodes a PDU as iodata. Header lengths are always recalculated.
  """
  ...
  @doc """
  Decodes one PDU and leaves any bytes following its declared data field.
  """
  @spec decode(binary()) ::
