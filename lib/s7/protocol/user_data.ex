defmodule S7.Protocol.UserData.Parameter do
  @moduledoc "The common parameter item used by classic S7 userdata services."
...
defmodule S7.Protocol.UserData.Payload do
  @moduledoc "The common four-byte payload header and opaque userdata service bytes."
